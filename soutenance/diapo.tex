...
\section{Le projet}
	...
	\begin{frame}{Principales fonctionnalités développées}
		...
		\begin{block}{Paramétrage}
			\begin{itemize}
				\item Changement de la vitesse
				\item Changement de la taille des fruits
	...
	\begin{frame}{Problèmes rencontrés}
		\begin{tabular}{p{4.5cm} p{4.5cm}}
			...
			Problème de repeinture de l'écran. Les fruits tombaient seulement quand on appuyait sur un boutton. & 
			Appel de la fonction \texttt{invalidate()} à la fin de la fonction \texttt{onDraw()} afin de repeindre le canevas de manière
			régulière.\vspace{7px}\\
			\hline
			\vspace{7px}
			Problème lié à la << cueillette >> &\vspace{7px} Recalcule et changement des bornes de chaque fruit (liste de Rect).
		\end{tabular}
	\end{frame}
